...
plot(Mean_tempo + theme_minimal() + ggtitle("Mean tempo over the years"))
plot(tempo_box + ggtitle("Boxplot of tempo for the best and worst scoring songs"))

```

***

The tempo of Eurovision songs has been analyzed in two ways: over time and between successful and unsuccessful Eurovision songs.
...
![Dendogram of songs from Eurovision 2020](dend.png){width=49%}
![Distribution of best and worst scoring Eurovision songs](cluster.png){width=49%}
...
### The **political aspect** {data-commentary-width=600}
